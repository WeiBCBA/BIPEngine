        ...
        "g1": [
            {
                ...
                "Antecedent": "Kitchen blender noise started in adjacent breakroom",
                "Behavior": "Screamed loudly and slapped face 3 times",
                "Consequence": "RBT offered noise-canceling headphones and sensory chew tool"
            },
            {
                "Date_Time": "2026-08-10 10:30",
                "Setting": "Outdoor Playground",
                "Antecedent": "Transition prompt given to pack up sand toys",
                "Behavior": "Attempted to eat sand and dropped to floor crying",
                "Consequence": "RBT blocked mouth, redirected to oral chew tool, demand paused"
            },
            {
                "Date_Time": "2026-08-11 11:00",
                "Setting": "Table Therapy Room",
                "Antecedent": "Presented matching discrete trial worksheet",
                "Behavior": "Head banging on foam floor mat (3-4 forceful contacts)",
                "Consequence": "Therapist paused demand, presented PECS 'Break' card"
            },
            {
                ...
                "Consequence": "RBT prompted functional communication button 'More Juice'"
            }
        ],
        "g2": [
            {
        ...
        "behaviors": [
            {
                ...
                "triangulation_es": "65% Datos ABC directos + 25% Entrevista indirecta + 10% QABF (Escape 14/15).",
