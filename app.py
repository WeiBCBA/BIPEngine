...
with tab2:
    ...
    target_beh = c1.text_area("Target Behavior Description", "Screaming (>80dB), pushing materials, dropping to floor during transitions or when demands are presented.", height=80)
    beh_examples = c2.text_area("Examples of Target Behavior", "Throwing workbooks, yelling 'No!', hitting table with open palms.", height=80)
    beh_non_examples = c3.text_area("Non-Examples of Target Behavior", "Requesting 'Break' using PECS/AAC card, quietly sitting, asking for teacher assistance.", height=80)
