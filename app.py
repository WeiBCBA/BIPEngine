...
st.markdown(
    ...
    <div class="hipaa-banner">
        <div class="hipaa-title">🛡️ <strong>100% HIPAA & BACB ETHICS COMPLIANT</strong> | <strong>ZERO-CLOUD LOCAL PROCESSING</strong></div>
        <div class="hipaa-body">
            This tool strictly complies with HIPAA privacy regulations and BACB Ethics standards. All data parsing, analysis, and document formulation occur <strong>100% locally</strong> within your active browser session memory.
        </div>
    </div>
""",
    unsafe_allow_html=True,
